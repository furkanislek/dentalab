      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10">
        <div className="flex flex-col md:flex-row items-center  md:justify-between justify-center gap-12 md:gap-24">
          ...
          <div className="w-full flex flex-col items-center md:block md:w-1/2 order-2 md:order-2">
            <button className="hover:bg-indigo-100 hover:text-indigo-600 shadow-md  hover:shadow-xl transition-all duration-300 inline-block bg-indigo-100 text-indigo-600 px-4 sm:px-6 py-2 rounded-md text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              LOCATION
            </button>
            ...
            <p className="text-gray-500 text-base mb-8 max-w-md">
              This feature in our app allows users to see the real time location
              of their dentist or dental clinic.
            </p>
            <a
              href="#"
