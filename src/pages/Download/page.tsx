...
const DownloadPage = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 min-w-[50vw] max-w-[70vw] mx-auto min-h-[50vh] items-center">
      <div className="flex flex-col ">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-primary max-w-[80%]">
